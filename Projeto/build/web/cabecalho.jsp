...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark todo">
        <a class="navbar-brand" href="index.jsp"><img class="cabecalho" src="image/pizzaria-logo.png" height="25%"
                width="25%"></a>
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        <a class="dropdown-item" href="usuarioCadastrar.jsp">Cadastro Tipo Usuario</a>
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button"
                        aria-haspopup="true" aria-expanded="false">Mesas</a>
                    <div class="dropdown-menu">
        ...
        <form class="form-inline my-2 my-lg-0">
            <button type="button" class="btn btn-danger" title="" data-container="body" data-toggle="popover"
                data-placement="bottom" data-original-title="Popover Title">Usuario Ativo:
                ${usuario.nomeUsuario}</button>
            ...
            <a class="btn btn-primary m-2" href="${pageContext.request.contextPath}/entrar">Entrar</a>
            <a class="btn btn-primary m-2" href="usuarioCadastrar.jsp">Registrar Usuário</a>
        </form>
