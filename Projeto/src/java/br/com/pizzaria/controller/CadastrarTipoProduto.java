...
@WebServlet(name = "CadastrarTipoProduto", urlPatterns = {"/CadastrarTipoProduto"})
public class CadastrarTipoProduto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (dao.cadastrar(tipoProduto)) {
                mensagem = "Tipo Produto Cadastrado com Sucesso!!";
            } else {
                mensagem = "Problemas ao cadastrar Tipo de Produto";
            }
